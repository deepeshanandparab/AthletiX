...
class Match(models.Model):
    ...
    def __str__(self):
        return f'{self.match_type} Overs Match({self.id}) at {self.venue} on {self.match_date}'
...
class Scorecard(models.Model):
    ...
    def __str__(self):
        return f'({self.player.id}) {self.player}\'s score on match played at {self.match.venue}, {self.match.place}'
